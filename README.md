...
![task6_result](task6_result.png "task6_result").
...
### Результат (Завдання 7).

 - <b>simulate_dice_rolls:</b> Ця функція моделює num_rolls кидків двох кубиків і підраховує, скільки разів з’являється кожна сума від 2 до 12.

Ми порівнюємо отримані ймовірності за методом <b>Монте-Карло</b> з <b>Аналітичними</b> ймовірностями для кожної суми.

![task71_result](task71_result.png "task71_result").

Графічне відображення

![task72_result](task72_result.png "task72_result").

<b>Отже</b>

На графіку ми побачимо, що ймовірності, отримані методом Монте-Карло, близькі до аналітичних значень, але можуть мати незначні відхилення через випадковість симуляції.
